...
function validateFile(file: File): string | null {
  ...
  if (file.size > MAX_FILE_SIZE) return 'Размер файла не должен превышать 100 МБ.';
  return null;
}
