...
Пользователь входит по одноразовому коду из корпоративной почты, заполняет профиль, прикладывает модели STL/STEP/3MF и следит за статусом заявки. Администратор управляет заявками, материалами, цветами, ролями и статистикой.
